...
try{
 ...
 const exported=await page.evaluate(async()=>{
  window.exportPhase='prepare';const v=window.veyra,{renderVideo,recordingFormats}=await import(new URL('./studio/packages/renderer/index.js',location.href));
